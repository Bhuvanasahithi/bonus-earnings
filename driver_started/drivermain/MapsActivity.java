...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private Dialog mVerificationDialog,mDriverRequestDialog,mSurgeEffectDialog,mScheduledNotifications;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // mDriverstartedRide.show();
        ...
        //dialog for start ride
        BottomSheetDialog mStartRideDialog=new BottomSheetDialog(this);
        mStartRideDialog.setContentView(layout.driver_start_ride);
        //mStartRideDialog.show();
        //displaying the scheduled notifications dialog
        mScheduledNotifications=new Dialog(this);
        mScheduledNotifications.setContentView(layout.driver_scheduled_notifications);
        mScheduledNotifications.show();
    }
    @Override
